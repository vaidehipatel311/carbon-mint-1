...
function Operators({ fetchOperator, fetchCrops, fetchEvents, fetchLandParcel }) {
    ...
    const [totalCrops,setTotalCrops] = useState([]);
                                ...
                                <Grid item xs={2.3}>
                                    <Item className='crops'>
                                        ...
                                        <div className='information'>
                                            ...
                                            <b><Typography variant='p' className='numbers'>{totalCrops.length}</Typography></b>
                                        </div>
